...
class SimpleCaptcha {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
			...
			//NOTA:ERROR CORREGIDO. Esta es la l�nea original. Como se ve m�s abajo, he a�adido la funci�n realpath y !!funciona!!
			//$coords = imagettftext($this->im, $fontsize, $degree,
            //    $x, $y,
            //    $this->GdFgColor, $fontfile, $letter);
				
			//echo "fontfile: " . realpath($fontfile);
            $coords = imagettftext($this->im, $fontsize, $degree,
                $x, $y,
                $this->GdFgColor, realpath($fontfile), $letter);
...
//NOTA: Comentando las l�neas header de la funci�n WriteImage vemos los errores producidos
