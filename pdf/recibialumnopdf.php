...
<br><br><br>
<p class="p1">RECIBÍ ALUMNO</p>
<br>
<p class="p2">D./Dª. <?php echo $apellido1; ?> <?php echo $apellido2; ?> <?php echo $nombre; ?>, con <?php echo $tipodoc; ?> nº <?php echo $nif; ?>, retira el certificado de 
Prevención de Riesgos Laborales de nivel Básico correspondiente al ciclo formativo de grado <?php echo $mediosuperior; ?> de <?php echo $descripcionestudio; ?>.</p>
<br><br>
<p class="p3center"><?php echo $localidad; ?>, a <?php echo $hoy['mday'] ; ?> de <?php echo $hoy['mon'] ; ?> de <?php echo $hoy['year'] ; ?></p>
<br><br>
<p>Fdo.: <?php echo $apellido1; ?> <?php echo $apellido2; ?> <?php echo $nombre; ?>
</div>
...
$sqlinsert = "INSERT INTO recibi (certificados_id, alumno_recibi,	escaneado_recibi,	administrativos_id) 
    VALUES ('" . $id_certificado . "','" . $si . "','" . $nombreArchivo .  "','" . $idsesion .  "')";
    echo $sqlinsert;
